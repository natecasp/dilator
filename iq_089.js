...
if(reward > 0) {
  $("#reward-box").append(`<p class="white-text strong">You have <span style="color:#8ac1c3;">`+ reward +`</span> free expedites.</p><div><input type="checkbox" id="apply-expedite"></input><p style="white-text strong"> Use expedite</p></div>`)
}
}, 1500);

console.log(user);

$("#apply-expedite").on('change', function(){
  if($(this).is(":checked")) {
...
if($("#apply-expedite").is(":checked")){
  ...
  $("#reward-counter").val(totalExpedites - 1);
    $("#reward-box").empty().append(`<p class="white-text strong">You have <span style="color:#8ac1c3;">`+ $("#reward-counter").val() +`</span> free expedites.</p><div><input type="checkbox" id="apply-expedite"></input><p style="white-text strong"> Use expedite</p></div>`)
}
});
