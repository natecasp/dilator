...
function checkMaterial() {
  var material = $("#material-2").val();
   ...
   if (['LDPE'].includes(material)) {$("#colorant").empty().append('<option value="None">None</option><option value="Cool Grey (4C)">Cool Grey (4C)</option>'); $("#color-2").empty().append('<option value="None">None</option><option value="BaSO4">20% BaSO4</option>').trigger('change');  return;}
   ...
   if (['Pebax 40D','Pebax 70D'].includes(material)) { $("#color-2").empty().append('<option value="None">None</option><option value="BaSO4">20% BaSO4</option>'); return;} 
   if (['Vestamid ML21'].includes(material)) { $("#color-2").empty().append('<option value="None">None</option><option value="Lubricious Additive">Lubricious Additive</option>'); return; }
