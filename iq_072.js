...
$("#material-2").on('change', function() {
 ...
 // changeRef(this.value);
  ...
  if (['LDPE'].includes(this.value)) {$("#colorant").empty().append('<option value="None">None</option><option value="Cool Grey (4C)">Cool Grey (4C)</option>'); $("#color-2").empty().append('<option value="BaSO4">20% BaSO4</option>').trigger('change');  return;}
