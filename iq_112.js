...
<div class="row">
    ...
    <label class="label" `+ label +`><input type="checkbox" class="expedited" id="l`+lineItem+`-expedite" readonly `+ expedite +`>Expedited</input>Free Expedite Applied</label>
	</div>
	<div class="col">
