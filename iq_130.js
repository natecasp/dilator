  ...
  if (driver === 'od' || driver === 'od-range') {
    if (unit === 'in') {
      ...
      if (od < 0.106*conversionFactor) {
        $("#od-tol-2").val(0.002 * conversionFactor);
        $("#wall-tol").val(0.002 * conversionFactor);
        if (taper < 3) {
        ...
        $("#od-tol-2").val(0.003*conversionFactor);
        $("#wall-tol").val(0.003*conversionFactor);
        if (taper < 5) {
          $("#taper, #taper-range").val(5);
          angleController.setValue(5);
        }
      } else if (od > 0.340*conversionFactor) {
        $("#od-tol-2").val(0.004*conversionFactor);
        $("#wall-tol").val(0.004*conversionFactor);
        if (taper < 5) {
          $("#taper, #taper-range").val(5);
          angleController.setValue(5);
        }
...
function checkLength(length, conversion) {
  ...
  var minLength = ($("#unit").val() == 'in') ? 12 : 304;
...
function calculate() {
  ...
  if (unit == 'in') {
    ...
    if (od < 0.106*conversionFactor) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.002*conversionFactor;
      odTol = 0.002*conversionFactor;
      minAngle = 3;
    } else if (od >= (0.107*conversionFactor) && od < (0.183*conversionFactor)) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      ...
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.003*conversionFactor;
      odTol = 0.003*conversionFactor;
      minAngle = 5;
    } else {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.004*conversionFactor;
      odTol = 0.004*conversionFactor;
      minAngle = 5;
    }
