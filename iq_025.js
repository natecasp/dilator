...
$("#wall-slider-container").append(`<div id="wall-possibility" style="position:absolute; top:-5;height:10px;width:20%;left:`+ ((minW / Number(max))*100) +`%; background: #8ac1c3; opacity:0.5;"></div>`);
});
