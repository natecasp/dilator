...
if( $("#apply-expedite").is(":checked") ) {
  ...
  var expeditesInQuote = document.querySelectorAll(".expedited:checkbox:checked");
  var expeditesRemaining  = Number($("#reward-counter").val()) - expeditesInQuote;
  if ( expeditesRemaining > 0 ) {
   $("#reward-counter").val(Number($("#reward-counter").val()) - expeditesInQuote);
