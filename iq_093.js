...
if(reward > 0) {
  $("#reward-box").append(`<p class="white-text strong" style="display:flex;flex-direction: row;">You have &nbsp<span style="color:#8ac1c3;">`+ reward +`</span>&nbsp free expedites.</p><div style="display:flex;align-items:center;"><input type="checkbox" id="apply-expedite"></input><p class="white-text strong"> Use expedite</p></div>`)
}
}, 1500);
...
if($("#apply-expedite").is(":checked")) {
  ...
  var totalExpedites = $(".expedited:checkbox:checked").length;
  $("#reward-counter").val(totalExpedites - 1);
  if ( totalExpedites > 0 ) {
  $("#reward-box").empty().append(`<p class="white-text strong" style="display:flex;flex-direction: row;">You have &nbsp<span style="color:#8ac1c3;">`+ $("#reward-counter").val() +`</span>&nbsp free expedites.</p><div style="display:flex;align-items:center;"><input type="checkbox" id="apply-expedite"></input><p class="white-text strong"> Use expedite</p></div>`)
  } else {
  $("#reward-box").empty();
  }
} else {
...
if($("#apply-expedite").is(":checked")) {
  ...
  if(user.model.reward > 0){
  var totalExpedites = Number($("#reward-counter").val()) - 1;
  $("#reward-counter").val(totalExpedites);
    $("#reward-box").append(`<p class="white-text strong" style="display:flex;flex-direction: row;">You have &nbsp<span style="color:#8ac1c3;">`+ $("#reward-counter").val() +`</span>&nbsp free expedites.</p><div style="display:flex;align-items:center;"><input type="checkbox" id="apply-expedite"></input><p class="white-text strong"> Use expedite</p></div>`)
