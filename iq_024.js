...
var minW = Number(this.value) * 0.4;
var maxW = Number(this.value) * 0.6;
var max = $("#wall-range").attr('max');
if ($("#wall-possibility")) {
$("#wall-possibility").remove();
}
$("#wall-slider-container").append(`<div id="wall-possibility" style="position:absolute;height:10px;width:20%;left: background: #8ac1c3; opacity:0.5;`+ (Number(max) / minW) +`"></div>`);
});
