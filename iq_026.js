...
$("#wall-slider-container").append(`<div id="wall-possibility" style="position:absolute;border: 2px solid #8ac1c3; border-bottom:none;border-radius: 5px 5px 0px 0px; top:-5px;height:7px;width:`+ (((maxW / Number(max))*100) - ((minW / Number(max))*100)) +`%;left:`+ ((minW / Number(max))*100) +`%; background: #8ac1c3; opacity:0.5;"></div>`);
});
