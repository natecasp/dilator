...
var minW = ((Number(this.value) * 0.4) /2) - Number($("#wall-range").attr('min'));
var maxW = ((Number(this.value) * 0.6) /2) - Number($("#wall-range").attr('min'));
var max = Number($("#wall-range").attr('max')) - Number($("#wall-range").attr('min'));
if ( ((Number(this.value) * 0.6) /2) > Number($("#wall-range").attr("max"))) {
  maxW = Number($("#wall-range").attr("max"));
}
