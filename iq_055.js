...
function validate(wallMin, wallMax, minAngle, wallTol, odTol, isSoft){
  ...
  var wallTolerance = $("#wall-tol").val();
  var length = Number($("#length-2").val());
  if((wall >= wallMin && wall <= wallMax) && (taper >= minAngle) && (taperTolerance >= 1) && (length <=60) && (length >=12) && (qty <= 50) && ( od <= 0.350 ) && ( od >= 0.079 ) && (lengthTol == 'min') && (material !== '') && (tipId !== '') && (Number(odTolerance) >= Number(odTol)) && (Number(wallTolerance) >= Number(wallTol))) { 
...
function validate(wallMin, wallMax, minAngle, wallTol, odTol, isSoft){
  ...
  var wallTolerance = $("#wall-tol").val();
  var length = Number($("#length-2").val());
  if((wall >= wallMin && wall <= wallMax) && (taper >= minAngle) && (taperTolerance >= 1) && (length <=1524) && (length >=304) && (qty <= 50) && ( od <= 8.89 ) && ( od >= 2 ) && (lengthTol == 'min') && (material !== '') && (tipId !== '') && (Number(odTolerance) >= Number(odTol)) && (Number(wallTolerance) >= Number(wallTol))) { 
    $("#custom-quote").prop('checked', false);
    $("#custom-quote").trigger('change');
    greenlight.prop('checked', true);
    greenlight.trigger('change'); 
