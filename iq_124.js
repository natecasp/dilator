...
var colorInput = $("#material-2").val();
if(colorInput == '#ffffff') {var color = '#ffffff' };
...
function checkIdTol(idTol, conversion) {
  if (Number(idTol) > (Number($("#id-2").val()) * 0.2)) {
    addError(
      'id-tol-high',
...
function calculate() {
  ...
  if (unit == 'in') {
    if (od < 0.106) {
      ...
      odTol = 0.002;
      minAngle = 3;
    } else if (od >= 0.107 && od < 0.183) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.002;
      odTol = 0.002;
      minAngle = 3;
    } else if (od > 0.183 && od < 0.262) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.002;
      odTol = 0.002;
      minAngle = 4;
    } else if (od > 0.262 && od < 0.340) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.003;
      odTol = 0.003;
    ...
    if (od < 2.69) {
      ...
      odTol = 0.05;
      minAngle = 3;
    } else if (od >= 2.7 && od < 4.65) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.05;
      odTol = 0.05;
      minAngle = 3;
    } else if (od > 4.65 && od < 6.65) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.05;
      odTol = 0.05;
      minAngle = 4;
    } else if (od > 6.65 && od < 8.64) {
      wallMin = (od * 0.2) / 2;
      wallMax = (od * 0.7) / 2;
      wallTol = 0.076;
      odTol = 0.076;
